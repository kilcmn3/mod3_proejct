...
function battleRender() {
  document.addEventListener("click", function (event) {
    if (event.target.className === "team-button") {
      ...
      <div class="poke-card" data-id="0"><img src="${json.pokemons[0].image_url}" class="image"><h3>${json.pokemons[0].name}</h3>Moves:<ul id="poke-1-list"></ul></div>
      <div class="poke-card" data-id="1"><img src="${json.pokemons[1].image_url}" class="image"><h3>${json.pokemons[1].name}</h3>Moves:<ul id="poke-2-list"></ul></div>
      <div class="poke-card" data-id="2"><img src="${json.pokemons[2].image_url}" class="image"><h3>${json.pokemons[2].name}</h3>Moves:<ul id="poke-3-list"></ul></div>
      <div class="poke-card" data-id="3"><img src="${json.pokemons[3].image_url}" class="image"><h3>${json.pokemons[3].name}</h3>Moves:<ul id="poke-4-list"></ul></div>
      <div class="poke-card" data-id="4"><img src="${json.pokemons[4].image_url}" class="image"><h3>${json.pokemons[4].name}</h3>Moves:<ul id="poke-5-list"></ul></div>
      <div class="poke-card" data-id="5"><img src="${json.pokemons[5].image_url}" class="image"><h3>${json.pokemons[5].name}</h3>Moves:<ul id="poke-6-list"></ul></div>
      `
      ...
      document.addEventListener("click", function (event) {
        if (event.target.className === "image") {
          ...
          userContainer.dataset.id = json.pokemons[event.target.parentNode.dataset.id].id
          userContainer.innerHTML = `
          <img src="${json.pokemons[event.target.parentNode.dataset.id].image_url}" class="user-image"><h3>${json.pokemons[event.target.parentNode.dataset.id].name}</h3>Moves:<ul id="user-moves-list"></ul>
          `
